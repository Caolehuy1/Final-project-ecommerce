                    ...
                    <div class="row">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    ...
                                    <div class="pt active" data-imgbigurl="front/img/products/{{$productImage->path}}">
                                        <img src="/front/img/products/{{$productImage->path}}" height="200px" alt="">
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="pd-desc">
                                    <p>{{$product->content}}Usually ships within 2 to 3 days.</p>
                                ...
                                <ul class="pd-tags">
                                    ...
                                    <li><span>Material</span>: PVC, Plastic, Nylon </li>
                                    <li><span>Item Weight</span>: {{$product->weight}} </li>
                                    <li><span>Item Dimensions</span>: {{$product->size}}</li>
                                </ul>
                                <b class="text-bold">About this Item</b>
                                <li><span>Brand: Inflame Toys</span></li>
                                        ...
                                        <div class="specification-table">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="p-price">${{$product->price}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="cart-add">PVC, Plastic, Nylon</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="p-weight">{{$product->weight}} Kilograms</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                @foreach($product->productComments as $productComment)
                                                    <div class="co-item">
                                                        <div class="avatar-pic">
                                                            <img src="/front/img/user/{{ $productComment->user->avatar ?? 'avatar.jpg' }}" alt="">
                                                        </div>
